...
def LanguageUsed():
    ...
    try:
        with open(
            "/etc/enigma2/settings", "r", encoding="utf-8", errors="ignore"
        ) as lang:
...
def getBoxVuModel():
    vumodel = "UNKNOWN"
    if os.path.exists("/proc/stb/info/vumodel") and not os.path.exists(
...
def getKernelVersion():
    if not os.path.exists("/tmp/.isnandsim"):
        if (
            os.system("opkg list-installed | grep kernel-module-nandsim" + dev_null)
            != 0
        ):
    ...
    if os.path.exists("" +
        ...
        try:
            result = (
                subprocess.check_output(["uname", "-r"], text=True, errors="ignore")
                .strip("\n")
                .split("-")
            )
...
def NEOBootMainEx(
    ...
    list_two = [
        ...
        "/etc/hostname" +
        dev_null,
        "cp -a /usr/share/enigma2/rc_models/* " +
        media_target +
        ...
        "cp -af " +
        extensions_path +
        "NeoBoot/files/backflash " +
        media_target +
        extensions_path +
        "NeoReboot/backflash.sh" +
        dev_null,
        "cp -af " +
        extensions_path +
        "NeoBoot/files/neoreboot " +
        media_target +
        extensions_path +
        "NeoReboot/plugin.py" +
        dev_null,
    ...
    if CopyKernel == "True":
        if (
            ...
            or getCPUSoC() == "7405"
            and os.path.exists("%s/ImageBoot/%s/etc/vtiversion.info" % (media, target))
        ):
            ...
            or getBoxHostName() == "vuduo4k"
            or getBoxHostName() == "vuduo4kse"
            or getBoxHostName() == "vuzero4k"
        ):
            os.system(
                "mv "
                + getNeoLocation()
    ...
    if not os.path.exists(
        ...
        if os.path.exists("/usr/sbin/nandwrite"):
            cmd = (
                "cp -af /usr/sbin/nandwrite %s/ImageBoot/%s/usr/sbin/nandwrite > /dev/null 2>&1" %
                (media, target))
            rc = os.system(cmd)
        if os.path.exists("/usr/bin/fullwget"):
            cmd = (
                "cp -af /usr/bin/fullwget %s/ImageBoot/%s/usr/bin/fullwget > /dev/null 2>&1" %
                (media, target))
            rc = os.system(cmd)
        if os.path.exists("/etc/init.d/inadyn-mt"):
            cmd = (
                "cp -af /etc/init.d/inadyn-mt %s/ImageBoot/%s/etc/init.d/inadyn-mt > /dev/null 2>&1" %
                (media, target))
            rc = os.system(cmd)
        if os.path.exists("/usr/bin/inadyn-mt"):
            cmd = (
                "cp -af /usr/bin/inadyn-mt %s/ImageBoot/%s/usr/bin/inadyn-mt > /dev/null 2>&1" %
                (media, target))
            rc = os.system(cmd)
        if os.path.exists("/etc/inadyn.conf"):
            cmd = (
                "cp -af /etc/inadyn.conf %s/ImageBoot/%s/etc/inadyn.conf > /dev/null 2>&1" %
                (media, target))
            rc = os.system(cmd)
        if os.path.exists(
                "/usr/lib/enigma2/python/Plugins/SystemPlugins/FanControl"):
            cmd = (
                "cp -af /usr/lib/enigma2/python/Plugins/SystemPlugins/FanControl %s/ImageBoot/%s/usr/lib/enigma2/python/Plugins/SystemPlugins > /dev/null 2>&1" %
                (media, target))
            rc = os.system(cmd)
        ...
        if os.path.exists("" + extensions_path + "IPTVPlayer"):
            ...
            rc = os.system(cmd)
            cmd = (
                "cp /usr/lib/python*.*/htmlentitydefs.pyo %s/ImageBoot/%s/usr/lib/python*.* > /dev/null 2>&1" %
                (media, target))
            rc = os.system(cmd)
        ...
        if not os.path.exists(
            "%s/ImageBoot/%s/usr/lib/enigma2/python/boxbranding.so" %
                (media, target)):
            cmd = (
                "cp -af /usr/lib/enigma2/python/boxbranding.so %s/ImageBoot/%s/usr/lib/enigma2/python/boxbranding.so > /dev/null 2>&1" %
                (media, target))
            rc = os.system(cmd)
        if os.path.exists(
        ...
        if LanWlan == "True":
            ...
            elif os.path.exists("/etc/vtiversion.info") and os.path.exists(
                "%s/usr/lib/enigma2/python/Plugins/PLi" % (media, target)
            ):
                os.system(
                    'echo "Not copied LAN-WLAN, not recommended for this image."')
            elif os.path.exists("/etc/bhversion") and os.path.exists(
                "%s/usr/lib/enigma2/python/Plugins/PLi" % (media, target)
            ):
                os.system(
                    'echo "Not copied LAN-WLAN, not recommended for this image."')
            if os.path.exists("/etc/wpa_supplicant.wlan0.conf"):
                cmd = (
                    "cp -af /etc/wpa_supplicant.wlan0.conf %s/ImageBoot/%s/etc/wpa_supplicant.wlan0.conf > /dev/null 2>&1" %
                    (media, target))
                rc = os.system(cmd)
            if os.path.exists("/etc/network/interfaces"):
                cmd = (
                    "cp -af /etc/network/interfaces %s/ImageBoot/%s/etc/network/interfaces > /dev/null 2>&1" %
                    (media, target))
                rc = os.system(cmd)
            if os.path.exists("/etc/wpa_supplicant.conf"):
                cmd = (
                    "cp -af /etc/wpa_suppligetinstallscant.conf %s/ImageBoot/%s/etc/wpa_supplicant.conf > /dev/null 2>&1" %
                    (media, target))
                rc = os.system(cmd)
            if os.path.exists("/etc/resolv.conf"):
                cmd = (
                    "cp -af /etc/resolv.conf %s/ImageBoot/%s/etc/resolv.conf > /dev/null 2>&1" %
                    (media, target))
                rc = os.system(cmd)
            if os.path.exists("/etc/wl.conf.wlan3"):
                cmd = (
                    "cp -af /etc/wl.conf.wlan3 %s/ImageBoot/%s/etc/wl.conf.wlan3 > /dev/null 2>&1" %
                    (media, target))
                rc = os.system(cmd)
            ...
            if getCPUtype() == "MIPS":
                if os.path.exists(
                    "%s/ImageBoot/%s/etc/fstab" %
                        (media, target)):
                    cmd = (
                        "mv %s/ImageBoot/%s/etc/fstab %s/ImageBoot/%s/etc/fstab.org" %
                ...
                if os.path.exists(
                    "%s/ImageBoot/%s/etc/init.d/volatile-media.sh" %
                        (media, target)):
                    cmd = (
                        "mv %s/ImageBoot/%s/etc/init.d/volatile-media.sh %s/ImageBoot/%s/etc/init.d/volatile-media.sh.org" %
                        (media, target, media, target))
                    rc = os.system(cmd)
        ...
        if InstallSettings == "True":
            ...
            rc = os.system(cmd)
            if not os.path.exists(
                "%s/ImageBoot/%s/etc/tuxbox/config" % (media, target)
            ):
                cmd = (
                    "mkdir -p /etc/tuxbox/config %s/ImageBoot/%s/etc/tuxbox/config" %
                    (media, target))
                rc = os.system(cmd)
        ...
        if SoftCam == "True":
            ...
            if os.path.exists("/etc/tuxbox/config"):
                cmd = (
                    "cp -af /etc/tuxbox/config %s/ImageBoot/%s/etc/tuxbox > /dev/null 2>&1" %
                    (media, target))
                rc = os.system(cmd)
        ...
        if MediaPortal == "True":
            if os.path.exists("" + extensions_path + "MediaPortal"):
                ...
                rc = os.system(cmd)
                cmd = (
                    "cp -af /usr/lib/python2.7/argparse.pyo %s/ImageBoot/%s/usr/lib/python2.7 > /dev/null 2>&1" %
                    (media, target))
                rc = os.system(cmd)
                cmd = (
                    "cp -af /usr/lib/python2.7/robotparser.pyo %s/ImageBoot/%s/usr/lib/python2.7 > /dev/null 2>&1" %
                    (media, target))
                rc = os.system(cmd)
                cmd = (
                    "cp -af /usr/lib/python2.7/site-packages/Crypto %s/ImageBoot/%s/usr/lib/python2.7/site-packages > /dev/null 2>&1" %
                    (media, target))
                rc = os.system(cmd)
                cmd = (
                    "cp -af /usr/lib/python2.7/site-packages/mechanize %s/ImageBoot/%s/usr/lib/python2.7/site-packages > /dev/null 2>&1" %
                    (media, target))
                rc = os.system(cmd)
                cmd = (
                    "cp -af /usr/lib/python2.7/site-packages/requests %s/ImageBoot/%s/usr/lib/python2.7/site-packages > /dev/null 2>&1" %
                    (media, target))
                rc = os.system(cmd)
                cmd = (
                    "cp -af /usr/lib/python2.7/site-packages/requests-2.11.1-py2.7.egg-info %s/ImageBoot/%s/usr/lib/python2.7/site-packages > /dev/null 2>&1" %
                    (media, target))
                rc = os.system(cmd)
                ...
                if os.path.exists("/etc/enigma2/mp_pluginliste"):
                    cmd = (
                        "cp /etc/enigma2/mp_pluginliste %s/ImageBoot/%s/etc/enigma2" %
                        (media, target))
                    rc = os.system(cmd)
        ...
        if PiconR == "True":
            if os.path.exists("/usr/share/enigma2/picon"):
                cmd = (
                    "cp -af /usr/share/enigma2/picon %s/ImageBoot/%s/usr/share/enigma2" %
                    (media, target))
                rc = os.system(cmd)
        ...
        if BlackHole == "True":
            if "BlackHole" in source or os.path.exists(
                ...
                cmd = (
                    "mkdir -p "
                    + getNeoLocation()
                    + "ImageBoot/%s/boot/blackhole" % target
                )
                rc = os.system(cmd)
                cmd = (
                    "mv " +
                    ...
                    "ImageBoot/" +
                    target +
                    "/usr/lib/enigma2/python/Blackhole/BhUtils.pyo " +
                    getNeoLocation() +
                    "ImageBoot/%s/usr/lib/enigma2/python/Blackhole/BhUtils.pyo.org" %
                    target)
                rc = os.system(cmd)
                cmd = (
                    "cp -af " +
                    ...
                    "NeoBoot/bin/utilsbh " +
                    getNeoLocation() +
                    "ImageBoot/%s/usr/lib/enigma2/python/Blackhole/BhUtils.py" %
                    target)
                rc = os.system(cmd)
                ...
                localfile = (
                    ""
                    + getNeoLocation()
                    + "ImageBoot/%s/boot/blackhole/version" % target
                )
                try:
                    with open(
                        localfile, "w", encoding="utf-8", errors="ignore"
                    ) as temp_file:
                ...
                cmd = (
                    ...
                    + "/usr/bin/enigma2 "
                    + getNeoLocation()
                    + "ImageBoot/%s/usr/bin/enigma2-or" % target
                )
                rc = os.system(cmd)
                ...
                fail = (
                    "" +
                    getNeoLocation() +
                    "ImageBoot/%s/usr/bin/enigma2-or" %
                    target)
                content = ""
                try:
                ...
                if content:
                    localfile2 = (
                        "" +
                        getNeoLocation() +
                        "ImageBoot/%s/usr/bin/enigma2" %
                        target)
                    try:
                        with open(
                            localfile2, "w", encoding="utf-8", errors="ignore"
                        ) as temp_file2:
                            temp_file2.write(
                                content.replace(
    ...
    if not os.path.exists(
    ...
    ) and not os.path.exists(" /tmp/settings_copied"):
        try:
            with open("/etc/hostname", "r", encoding="utf-8", errors="ignore") as f:
                for line in f:
                    if (
                        ...
                        if os.path.exists(
                            "%s/ImageBoot/%s/etc/enigma2" % (media, target)
                        ):
                        ...
                        if not os.path.exists(
                            ...
                            rc = os.system(cmd)
                        cmd = (
                            'grep "config.Nims" /etc/enigma2/settings >> %s/ImageBoot/%s/etc/enigma2/settings' %
                            (media, target))
                        rc = os.system(cmd)
                        cmd1 = (
                            'grep "av.videomode.DVI" /etc/enigma2/settings >> %s/ImageBoot/%s/etc/enigma2/settings' %
                            (media, target))
                        rc = os.system(cmd1)
                        cmd2 = (
                            'grep "config.OpenWebif" /etc/enigma2/settings >> %s/ImageBoot/%s/etc/enigma2/settings' %
                            (media, target))
                        rc = os.system(cmd2)
                        cmd3 = (
                            'grep "config.osd" /etc/enigma2/settings >> %s/ImageBoot/%s/etc/enigma2/settings' %
                            (media, target))
                        rc = os.system(cmd3)
                        cmd4 = (
                            'grep "config.timezone.val" /etc/enigma2/settings >> %s/ImageBoot/%s/etc/enigma2/settings' %
                            (media, target))
                        rc = os.system(cmd4)
                        cmd5 = (
                            'grep "config.servicelist.startuproot" /etc/enigma2/settings >> %s/ImageBoot/%s/etc/enigma2/settings' %
                            (media, target))
                        rc = os.system(cmd5)
                        cmd6 = (
                            'grep "UUID=" /etc/fstab >> %s/ImageBoot/%s/etc/fstab' %
                            (media, target))
                        rc = os.system(cmd6)
        except Exception as e:
        ...
        if (
            not os.path.exists(
                "" + media_target + "/boot/zImage." + getBoxHostName() + ""
            )
            and getCPUtype() == "MIPS"
        ):
            ...
            if os.path.exists(targetfile):
                ...
                try:
                    with open(targetfile, "r", encoding="utf-8", errors="ignore") as f:
                        lines = f.readlines()
                    with open(
                        targetfile2, "w", encoding="utf-8", errors="ignore"
                    ) as out:
                        for line in lines:
            ...
            if os.path.exists(mypath):  # Check if path exists before listing
                for fn in os.listdir(mypath):
                    if ((fn.find("kernel-image") != -
                         1 and fn.find("postinst") != -
                        1) or fn.find("-bootlogo.postinst") != -
                        1 or fn.find("-bootlogo.postrm") != -
                        1 or fn.find("-bootlogo.preinst") != -
                        1 or fn.find("-bootlogo.prerm") != -
                            1):
                        ...
                        try:
                            ...
                            with open(
                                filename2, "w", encoding="utf-8", errors="ignore"
                            ) as out:
                                for line in lines:
                                    if line.find("/boot") != -1:
                                        line = line.replace(
            ...
            if os.path.exists(
                ...
                cmd = (
                    ...
                    + "/var/lib/opkg/status "
                    + getNeoLocation()
                    + "ImageBoot/%s/var/lib/opkg/status-or" % target
                )
                rc = os.system(cmd)
                ...
                if content:
                    localfile2 = (
                        ""
                        + getNeoLocation()
                        + "ImageBoot/%s/var/lib/opkg/status" % target
                    )
                    try:
                        with open(
                            localfile2, "w", encoding="utf-8", errors="ignore"
    ...
    if os.path.exists("%s/ImageBoot/%s/usr/lib" % (media, target)):
        cmd = (
            "cp -af /usr/lib/periodon "
            + getNeoLocation()
            + "ImageBoot/%s/usr/lib/" % target
        )
        rc = os.system(cmd)
        cmd = (
            "mkdir -p "
        ...
        rc = os.system(cmd)
        cmd = (
            "cp -af /usr/lib/enigma2/python/Tools/Testinout.py "
            + getNeoLocation()
            + "ImageBoot/%s/usr/lib/enigma2/python/Tools/" % target
        )
        rc = os.system(cmd)
    ...
    try:
        with open(
            mediahome + ".neonextboot", "w", encoding="utf-8", errors="ignore"
        ) as out:
            out.write(target)
    except Exception as e:
    ...
    if ".tar.xz" not in source and not os.path.exists(
        ...
        os.system(
            'echo ""; echo "No system installed! The reason for the installation error may be badly packed image files or it is not a system for your model."'
        )
        os.system(
...
def RemoveUnpackDirs():
    ...
    ) or os.path.exists("" + getNeoLocation() + "ImagesUpload/gigablue/x34k"):
        rc = os.system("rm -r " + getNeoLocation() + "ImagesUpload/gigablue")
    elif os.path.exists(
        "" + getNeoLocation() + "ImagesUpload/gigablue"
    ) and os.path.exists("" + getNeoLocation() + "ImagesUpload/usb_update.bin"):
        rc = os.system(
            "mv "
            + getNeoLocation()
            + "ImagesUpload/usb_update.bin "
...
def NEOBootExtract(source, target, ZipDelete, Nandsim):
    RemoveUnpackDirs()
    os.system(
        'echo "Press green to hide Console or red to abort the installation\nInstallation started:"; date +%T;echo "Extracting the installation file..."'
    )
    ...
    if os.path.exists(sourcefile2):
        if sourcefile2.endswith(".nfi"):
            ...
            rc = os.system(cmd)
            if os.path.exists(
                "%sImageBoot/%s/media/squashfs-images" % (media, target)
            ) and os.path.exists("%s/squashfs-images" % (media)):
                os.system(
    ...
    if (
        getCPUtype() == "MIPS"
        and not os.path.exists("/tmp/root_jffs2")
        and not os.path.exists("/tmp/other_image")
    ):
        ...
        if (
            Nandsim == "True"
            or os.path.exists("/tmp/.isnandsim")
            or os.path.exists(
            ...
            if os.path.exists(
                ...
                rootfname = "rootfs.bin"
                if os.path.exists(
                    "" + getNeoLocation() + "ImagesUpload/miraclebox/mini"
                ):
                    os.chdir("mini")
                if os.path.exists(
                    "" + getNeoLocation() + "ImagesUpload/miraclebox/miniplus"
                ):
                    os.chdir("miniplus")
                if os.path.exists(
                    "" +
                    ...
                    os.chdir("minihybrid")
                if os.path.exists(
                    "" + getNeoLocation() + "ImagesUpload/miraclebox/twin"
                ):
                    os.chdir("twin")
                if os.path.exists(
                    "" + getNeoLocation() + "ImagesUpload/miraclebox/ultra"
                ):
                    os.chdir("ultra")
                if os.path.exists(
                    "" + getNeoLocation() + "ImagesUpload/miraclebox/micro"
                ):
                    os.chdir("micro")
                if os.path.exists(
                    "" + getNeoLocation() + "ImagesUpload/miraclebox/twinplus"
                ):
                    os.chdir("twinplus")
            ...
            if os.path.exists(
                "" + getNeoLocation() + "ImagesUpload/dm520"
            ) and not os.path.exists("/tmp/dm_image"):
            ...
            if os.path.exists("/tmp/dm_image") and os.path.exists(
            ...
            "" + extensions_path + "NeoBoot/ubi_reader/ubi_extract_files.py"
        ) and not os.path.exists("/tmp/root_jffs2"):
            if os.path.exists(
                "" +
                getNeoLocation() +
            ...
            if os.path.exists(
                ...
                if os.path.exists(
                    ...
                    os.chdir("micro")
                if os.path.exists(
                    "" + getNeoLocation() + "ImagesUpload/miraclebox/microv2"
                ):
                    os.chdir("microv2")
                if os.path.exists(
                    "" + getNeoLocation() + "ImagesUpload/miraclebox/twinplus"
                    ...
                    os.chdir("twinplus")
                if os.path.exists(
                    "" + getNeoLocation() + "ImagesUpload/miraclebox/mini4k"
                ):
                    os.chdir("mini4k")
                if os.path.exists(
                    "" + getNeoLocation() + "ImagesUpload/miraclebox/ultra4k"
                ):
                    os.chdir("ultra4k")
            if os.path.exists("" + getNeoLocation() + "ImagesUpload/atemio"):
                os.chdir("atemio")
            ...
            if os.path.exists("" + getNeoLocation() + "ImagesUpload/vuplus"):
                ...
                if os.path.exists(
                    ...
                    if os.path.exists(
                        ...
                        ""
                        + getNeoLocation()
                        + "ImagesUpload/vuplus/solose/root_cfe_auto.jffs2"
                    ):
                        os.chdir("solose")
                        os.system("mv -f root_cfe_auto.jffs2 rootfs.bin")
                if os.path.exists(
                ...
                if os.path.exists(
                    ...
                    os.chdir("uno4k")
                if os.path.exists(
                    "" + getNeoLocation() + "ImagesUpload/vuplus/ultimo4k"
                ):
                    os.chdir("ultimo4k")
                if os.path.exists(
                    ...
                    os.chdir("duo4k")
                if os.path.exists(
                    "" + getNeoLocation() + "ImagesUpload/vuplus/duo4kse"
                ):
                    os.chdir("duo4kse")
                if os.path.exists(
                    "" +
                    ...
                    os.chdir("zero4k")
                if os.path.exists(
                    "" + getNeoLocation() + "ImagesUpload/vuplus/uno4kse"
                ):
                    os.chdir("uno4kse")
            if os.path.exists("" + getNeoLocation() + "ImagesUpload/et10000"):
                os.chdir("et10000")
            ...
            if os.path.exists(
                "" + getNeoLocation() + "ImagesUpload/vuplus/root_cfe_auto.*"
            ):
                os.system("mv -f root_cfe_auto.* rootfs.bin")
            cmd = (
                "chmod 777 "
                + extensions_path
                + "NeoBoot/ubi_reader/ubi_extract_files.py"
            )
            rc = os.system(cmd)
            cmd = (
                "python "
                + extensions_path
                + "NeoBoot/ubi_reader/ubi_extract_files.py rootfs.bin -o"
                + getNeoLocation()
                + "ubi"
            )
            rc = os.system(cmd)
        ...
        if (os.path.exists("" +
            ...
            if os.path.exists(
                ...
                "" + getNeoLocation() + "ImagesUpload/e2/update/rootfs.ubi"
            ):
                os.system(
                    "mv -f "
                    + getNeoLocation()
            ...
            "" + getNeoLocation() + "ImagesUpload/update/lunix/cfe/oe_rootfs.bin"
        ):
            os.chdir("update")
            os.system(
                "mv -f "
            ...
            cmd = (
                "chmod 777 "
                + getNeoLocation()
                + "ImagesUpload/vuplus/solo4k/rootfs.tar.bz2; tar -jxf "
                + getNeoLocation()
            ...
            cmd = (
                "chmod 777 "
                + getNeoLocation()
                + "ImagesUpload/vuplus/uno4k/rootfs.tar.bz2; tar -jxf "
                + getNeoLocation()
            ...
            cmd = (
                "chmod 777 "
                + getNeoLocation()
                + "ImagesUpload/vuplus/uno4kse/rootfs.tar.bz2; tar -jxf "
                + getNeoLocation()
            ...
            cmd = (
                "chmod 777 "
                + getNeoLocation()
                + "ImagesUpload/vuplus/zero4k/rootfs.tar.bz2; tar -jxf "
                + getNeoLocation()
            ...
            cmd = (
                "chmod 777 "
                + getNeoLocation()
                + "ImagesUpload/vuplus/ultimo4k/rootfs.tar.bz2; tar -jxf "
                + getNeoLocation()
            ...
            cmd = (
                "chmod 777 "
                + getNeoLocation()
                + "ImagesUpload/vuplus/duo4k/rootfs.tar.bz2; tar -jxf "
                + getNeoLocation()
            ...
            cmd = (
                "chmod 777 "
                + getNeoLocation()
                + "ImagesUpload/vuplus/duo4kse/rootfs.tar.bz2; tar -jxf "
                + getNeoLocation()
            ...
            cmd = (
                "chmod 777 "
                + getNeoLocation()
                + "ImagesUpload/sf4008/rootfs.tar.bz2; tar -jxf "
                + getNeoLocation()
                + "ImagesUpload/sf4008/rootfs.tar.bz2 -C "
                + getNeoLocation()
                + "ImageBoot/"
                + target
                + " > /dev/null 2>&1"
            ...
            cmd = (
                "chmod 777 "
                + getNeoLocation()
                + "ImagesUpload/octagon/sf8008m/rootfs.tar.bz2; tar -jxf "
                + getNeoLocation()
            ...
            cmd = (
                "chmod 777 "
                + getNeoLocation()
                + "ImagesUpload/octagon/sf8008/rootfs.tar.bz2; tar -jxf "
                + getNeoLocation()
            ...
            cmd = (
                "chmod 777 "
                + getNeoLocation()
                + "ImagesUpload/osmio4k/rootfs.tar.bz2; tar -jxf "
                + getNeoLocation()
                + "ImagesUpload/osmio4k/rootfs.tar.bz2 -C "
                + getNeoLocation()
                + "ImageBoot/"
                + target
                + " > /dev/null 2>&1"
            ...
            cmd = (
                "chmod 777 "
                + getNeoLocation()
                + "ImagesUpload/osmio4kplus/rootfs.tar.bz2; tar -jxf "
                + getNeoLocation()
            ...
            cmd = (
                "chmod 777 "
                + getNeoLocation()
                + "ImagesUpload/osmini4k/rootfs.tar.bz2; tar -jxf "
                + getNeoLocation()
                + "ImagesUpload/osmini4k/rootfs.tar.bz2 -C "
                + getNeoLocation()
                + "ImageBoot/"
                + target
                + " > /dev/null 2>&1"
            ...
            cmd = (
                "chmod 777 "
                + getNeoLocation()
                + "ImagesUpload/dm900/rootfs.tar.bz2; tar -jxf "
                + getNeoLocation()
                + "ImagesUpload/dm900/rootfs.tar.bz2 -C "
                + getNeoLocation()
                + "ImageBoot/"
                + target
                + " > /dev/null 2>&1"
            ...
            cmd = (
                "chmod 777 "
                + getNeoLocation()
                + "ImagesUpload/dm920; tar -jxf "
                + getNeoLocation()
                + "ImagesUpload/dm920/rootfs.tar.bz2 -C "
                + getNeoLocation()
                + "ImageBoot/"
                + target
                + " > /dev/null 2>&1"
            ...
            cmd = (
                "chmod 777 "
                + getNeoLocation()
                + "ImagesUpload/dreamtwo; tar -jxf "
                + getNeoLocation()
                + "ImagesUpload/dreamtwo/rootfs.tar.bz2 -C "
                + getNeoLocation()
                + "ImageBoot/"
                + target
                + " > /dev/null 2>&1"
            ...
            cmd = (
                "chmod 777 "
                + getNeoLocation()
                + "ImagesUpload/hd51/rootfs.tar.bz2; tar -jxf "
                + getNeoLocation()
                + "ImagesUpload/hd51/rootfs.tar.bz2 -C "
                + getNeoLocation()
                + "ImageBoot/"
                + target
                + " > /dev/null 2>&1"
            ...
            cmd = (
                "chmod 777 "
                + getNeoLocation()
                + "ImagesUpload/hd60/rootfs.tar.bz2; tar -jxf "
                + getNeoLocation()
                + "ImagesUpload/hd60/rootfs.tar.bz2 -C "
                + getNeoLocation()
                + "ImageBoot/"
                + target
                + " > /dev/null 2>&1"
            ...
            cmd = (
                "chmod 777 "
                + getNeoLocation()
                + "ImagesUpload/hd61/rootfs.tar.bz2; tar -jxf "
                + getNeoLocation()
                + "ImagesUpload/hd61/rootfs.tar.bz2 -C "
                + getNeoLocation()
                + "ImageBoot/"
                + target
                + " > /dev/null 2>&1"
            ...
            cmd = (
                "chmod 777 "
                + getNeoLocation()
                + "ImagesUpload/multibox/rootfs.tar.bz2; tar -jxf "
                + getNeoLocation()
                + "ImagesUpload/multibox/rootfs.tar.bz2 -C "
                + getNeoLocation()
                + "ImageBoot/"
                + target
                + " > /dev/null 2>&1"
            ...
            cmd = (
                "chmod 777 "
                + getNeoLocation()
                + "ImagesUpload/multiboxse/rootfs.tar.bz2; tar -jxf "
                + getNeoLocation()
            ...
            cmd = (
                "chmod 777 "
                + getNeoLocation()
                + "ImagesUpload/multiboxpro/rootfs.tar.bz2; tar -jxf "
                + getNeoLocation()
                + "ImagesUpload/multiboxpro/rootfs.tar.bz2 -C "
                + getNeoLocation()
                + "ImageBoot/"
                + target
                + " > /dev/null 2>&1"
            ...
            cmd = (
                "chmod 777 "
                + getNeoLocation()
                + "ImagesUpload/axas/axasc4k/rootfs.tar.bz2; tar -jxf "
                + getNeoLocation()
            ...
            cmd = (
                "chmod 777 "
                + getNeoLocation()
                + "ImagesUpload/e4hd/rootfs.tar.bz2; tar -jxf "
                + getNeoLocation()
                + "ImagesUpload/e4hd/rootfs.tar.bz2 -C "
                + getNeoLocation()
                + "ImageBoot/"
                + target
                + " > /dev/null 2>&1"
            ...
            cmd = (
                "chmod 777 "
                + getNeoLocation()
                + "ImagesUpload/gigablue/quad4k/rootfs.tar.bz2; tar -jxf "
                + getNeoLocation()
            ...
            cmd = (
                "chmod 777 "
                + getNeoLocation()
                + "ImagesUpload/gigablue/ue4k/rootfs.tar.bz2; tar -jxf "
                + getNeoLocation()
            ...
            cmd = (
                "chmod 777 "
                + getNeoLocation()
                + "ImagesUpload/update/revo4k/rootfs.tar.bz2; tar -jxf "
                + getNeoLocation()
            ...
            cmd = (
                "chmod 777 "
                + getNeoLocation()
                + "ImagesUpload/update/force3uhd/rootfs.tar.bz2; tar -jxf "
                + getNeoLocation()
            ...
            cmd = (
                "chmod 777 "
                + getNeoLocation()
                + "ImagesUpload/update/galaxy4k/rootfs.tar.bz2; tar -jxf "
                + getNeoLocation()
            ...
            "" + getNeoLocation() + "ImagesUpload/zgemma/h7/rootfs.tar.bz2"
        ):
            os.system('echo "Please wait. System installation Zgemma H7."')
            cmd = (
                "chmod 777 "
                + getNeoLocation()
                + "ImagesUpload/zgemma/h7/rootfs.tar.bz2; tar -jxf "
                + getNeoLocation()
                + "ImagesUpload/zgemma/h7/rootfs.tar.bz2 -C "
                + getNeoLocation()
                + "ImageBoot/"
                + target
                + " > /dev/null 2>&1"
            ...
            "" + getNeoLocation() + "ImagesUpload/h9/rootfs.ubi"
        ) or os.path.exists("" + getNeoLocation() + "ImagesUpload/h8/rootfs.ubi"):
            if os.path.exists(
                "" +
                getNeoLocation() +
                    "ImagesUpload/h9/rootfs.ubi"):
            ...
            "" + getNeoLocation() + "ImagesUpload/zgemma/h9/rootfs.tar.bz2"
        ):
            os.system('echo "Please wait. System installation Zgemma H9S ."')
            cmd = (
                "chmod 777 "
                + getNeoLocation()
                + "ImagesUpload/zgemma/h9/rootfs.tar.bz2; tar -jxf "
                + getNeoLocation()
                + "ImagesUpload/zgemma/h9/rootfs.tar.bz2 -C "
                + getNeoLocation()
                + "ImageBoot/"
                + target
                + " > /dev/null 2>&1"
            ...
            "" + getNeoLocation() + "ImagesUpload/zgemma/h9se/rootfs.tar.bz2"
        ):
            os.system('echo "Please wait. System installation Zgemma H9SE ."')
            cmd = (
                "chmod 777 "
                + getNeoLocation()
                + "ImagesUpload/zgemma/h9se/rootfs.tar.bz2; tar -jxf "
                + getNeoLocation()
            ...
            "" + getNeoLocation() + "ImagesUpload/zgemma/i55plus/rootfs.tar.bz2"
        ):
            os.system('echo "Please wait. System installation Zgemma i55plus ."')
            cmd = (
                "chmod 777 "
                + getNeoLocation()
                + "ImagesUpload/zgemma/i55plus/rootfs.tar.bz2; tar -jxf "
                + getNeoLocation()
            ...
            "" + getNeoLocation() + "ImagesUpload/h9combo/rootfs.tar.bz2"
        ):
            os.system('echo "Please wait. System installation Zgemma h9combo ."')
            cmd = (
                "chmod 777 "
                + getNeoLocation()
                + "ImagesUpload/h9combo/rootfs.tar.bz2; tar -jxf "
                + getNeoLocation()
                + "ImagesUpload/h9combo/rootfs.tar.bz2 -C "
                + getNeoLocation()
                + "ImageBoot/"
                + target
                + " > /dev/null 2>&1"
            ...
            "" + getNeoLocation() + "ImagesUpload/h9combose/rootfs.tar.bz2"
        ):
            os.system(
            ...
            cmd = (
                "chmod 777 "
                + getNeoLocation()
                + "ImagesUpload/h9combose/rootfs.tar.bz2; tar -jxf "
                + getNeoLocation()
                + "ImagesUpload/h9combose/rootfs.tar.bz2 -C "
                + getNeoLocation()
                + "ImageBoot/"
                + target
                + " > /dev/null 2>&1"
            ...
            cmd = (
                "chmod 777 "
                + getNeoLocation()
                + "ImagesUpload/h10/rootfs.tar.bz2; tar -jxf "
                + getNeoLocation()
                + "ImagesUpload/h10/rootfs.tar.bz2 -C "
                + getNeoLocation()
                + "ImageBoot/"
                + target
                + " > /dev/null 2>&1"
            ...
            cmd = (
                "chmod 777 "
                + getNeoLocation()
                + "ImagesUpload/h11/rootfs.tar.bz2; tar -jxf "
                + getNeoLocation()
                + "ImagesUpload/h11/rootfs.tar.bz2 -C "
                + getNeoLocation()
                + "ImageBoot/"
                + target
                + " > /dev/null 2>&1"
            ...
            cmd = (
                "chmod 777 "
                + getNeoLocation()
                + "ImagesUpload/miraclebox/mini4k/rootfs.tar.bz2; tar -jxf "
                + getNeoLocation()
            ...
            cmd = (
                "chmod 777 "
                + getNeoLocation()
                + "ImagesUpload/miraclebox/ultra4k/rootfs.tar.bz2; tar -jxf "
                + getNeoLocation()
            ...
            cmd = (
                "chmod 777 "
                + getNeoLocation()
                + "ImagesUpload/update/lunix3-4k; tar -jxf "
                + getNeoLocation()
            ...
            cmd = (
                "chmod 777 "
                + getNeoLocation()
                + "ImagesUpload/update/lunix4k; tar -jxf "
                + getNeoLocation()
            ...
            cmd = (
                "chmod 777 "
                + getNeoLocation()
                + "ImagesUpload/dinobot/u5; tar -jxf "
                + getNeoLocation()
            ...
            cmd = (
                "chmod 777 "
                + getNeoLocation()
                + "ImagesUpload/dinobot/u51; tar -jxf "
                + getNeoLocation()
            ...
            cmd = (
                "chmod 777 "
                + getNeoLocation()
                + "ImagesUpload/dinobot/u52; tar -jxf "
                + getNeoLocation()
            ...
            cmd = (
                "chmod 777 "
                + getNeoLocation()
                + "ImagesUpload/dinobot/u53; tar -jxf "
                + getNeoLocation()
            ...
            "" + getNeoLocation() + "ImagesUpload/dinobot/u55/rootfs.tar.bz2"
        ):
            os.system(
            ...
            cmd = (
                "chmod 777 "
                + getNeoLocation()
                + "ImagesUpload/dinobot/uu55; tar -jxf "
                + getNeoLocation()
            ...
            cmd = (
                "chmod 777 "
                + getNeoLocation()
                + "ImagesUpload/dinobot/u5pvr; tar -jxf "
                + getNeoLocation()
            ...
            cmd = (
                "chmod 777 "
                + getNeoLocation()
                + "ImagesUpload/dinobot/u57; tar -jxf "
                + getNeoLocation()
            ...
            cmd = (
                "chmod 777 "
                + getNeoLocation()
                + "ImagesUpload/uclan/ustym4kpro; tar -jxf "
                + getNeoLocation()
            ...
            cmd = (
                "chmod 777 "
                + getNeoLocation()
                + "ImagesUpload/ustym4kpro; tar -jxf "
                + getNeoLocation()
            ...
            cmd = (
                "chmod 777 "
                + getNeoLocation()
                + "ImagesUpload/et1x000; tar -jxf "
                + getNeoLocation()
                + "ImagesUpload/et1x000/rootfs.tar.bz2 -C "
                + getNeoLocation()
                + "ImageBoot/"
                + target
                + " > /dev/null 2>&1"
            ...
            "" + getNeoLocation() + "ImagesUpload/e2/update/rootfs.tar.bz2"
        ):
            os.system('echo "Please wait. System installation..."')
            cmd = (
                "chmod 777 "
                + getNeoLocation()
                + "ImagesUpload/e2/update; tar -jxf "
                + getNeoLocation()
                + "ImagesUpload/e2/update/rootfs.tar.bz2 -C "
                + getNeoLocation()
                + "ImageBoot/"
                + target
                + " > /dev/null 2>&1"
            ...
            cmd = (
                "chmod 777 "
                + getNeoLocation()
                + "ImagesUpload/beyonwiz/v2; tar -jxf "
                + getNeoLocation()
            ...
            cmd = (
                "chmod 777 "
                + getNeoLocation()
                + "ImagesUpload/amiko/viper4k; tar -jxf "
                + getNeoLocation()
            ...
            cmd = (
                "chmod 777 "
                + getNeoLocation()
                + "ImagesUpload/update/tmtwin4k/rootfs.tar.bz2; tar -jxf "
                + getNeoLocation()
            ...
            cmd = (
                "chmod 777 "
                + getNeoLocation()
                + "ImagesUpload/gigablue/trio4k; tar -jxf "
                + getNeoLocation()
            ...
            cmd = (
                "chmod 777 "
                + getNeoLocation()
                + "ImagesUpload/gigablue/ip4k; tar -jxf "
                + getNeoLocation()
            ...
            cmd = (
                "chmod 777 "
                + getNeoLocation()
                + "ImagesUpload/gigablue/x34k; tar -jxf "
                + getNeoLocation()
            ...
            cmd = (
                "chmod 777 "
                + getNeoLocation()
                + "ImagesUpload/protek4k; tar -jxf "
                + getNeoLocation()
                + "ImagesUpload/protek4k/rootfs.tar.bz2 -C "
                + getNeoLocation()
                + "ImageBoot/"
                + target
                + " > /dev/null 2>&1"
            ...
            cmd = (
                "chmod 777 "
                + getNeoLocation()
                + "ImagesUpload/pulse4k; tar -jxf "
                + getNeoLocation()
                + "ImagesUpload/pulse4k/rootfs.tar.bz2 -C "
                + getNeoLocation()
                + "ImageBoot/"
                + target
                + " > /dev/null 2>&1"
            ...
            cmd = (
                "chmod 777 "
                + getNeoLocation()
                + "ImagesUpload/pulse4kmini; tar -jxf "
                + getNeoLocation()
            ...
            cmd = (
                "chmod 777 "
                + getNeoLocation()
                + "ImagesUpload/bre2ze4k; tar -jxf "
                + getNeoLocation()
                + "ImagesUpload/bre2ze4k/rootfs.tar.bz2 -C "
                + getNeoLocation()
                + "ImageBoot/"
                + target
                + " > /dev/null 2>&1"
            ...
            cmd = (
                "chmod 777 "
                + getNeoLocation()
                + "ImagesUpload/vs1500; tar -jxf "
                + getNeoLocation()
                + "ImagesUpload/vs1500/rootfs.tar.bz2 -C "
                + getNeoLocation()
                + "ImageBoot/"
                + target
                + " > /dev/null 2>&1"
                ...
                if fn.find(".rootfs.tar.xz") != -1:
                    if not os.path.exists("/tmp/xz-gz-tar"):
                        ...
                        cmd = (
                            ...
                            + ".rootfs.tar.xz  "
                            + getNeoLocation()
                            + "ImagesUpload/rootfs.tar.xz > /dev/null 2>&1"
                        )
                        rc = os.system(cmd)
                        cmd1 = (
                            "mv "
                        ...
                        cmd = (
                            "chmod 777 "
                            + getNeoLocation()
                            + "ImagesUpload/rootfs.tar.xz; tar -xf "
                            + getNeoLocation()
                            + "ImagesUpload/rootfs.tar.xz -C "
                            + getNeoLocation()
                            + "ImageBoot/"
                            + target
                            + " > /dev/null 2>&1"
                    ...
                    if not os.path.exists("/tmp/xz-gz-tar"):
                        ...
                        cmd = (
                            "chmod 777 "
                            + getNeoLocation()
                            + "ImagesUpload/rootfs.tar.gz; /bin/tar -xzvf "
                            + getNeoLocation()
                            + "ImagesUpload/rootfs.tar.gz -C "
                            + getNeoLocation()
                            + "ImageBoot/"
                            + target
                            + " > /dev/null 2>&1"
                    ...
                    if not os.path.exists("/tmp/xz-gz-tar"):
                        ...
                        cmd = (
                            "chmod 777 "
                            + getNeoLocation()
                            + "ImagesUpload/rootfs.tar.bz2; tar -jxf "
                            + getNeoLocation()
                            + "ImagesUpload/rootfs.tar.bz2 -C "
                            + getNeoLocation()
                            + "ImageBoot/"
                            + target
                            + " > /dev/null 2>&1"
                    ...
                    cmd = (
                        "chmod 777 "
                        + getNeoLocation()
                        + "ImagesUpload/*.tar.gz; tar -xzvf "
                        + getNeoLocation()
                        + "ImagesUpload/*.tar.gz -C "
                        + getNeoLocation()
                        + "ImageBoot/"
                        + target
                        + " > /dev/null 2>&1"
                    ...
                    os.path.exists("" + getNeoLocation() + "ImagesUpload/rootfs.bin")
                    or fn.find(".bin") != -1
                ):
                    ...
                    if not os.path.exists("/tmp/xz-gz-tar"):
                        ...
                        cmd = (
                            "chmod 777 "
                            + getNeoLocation()
                            + "ImagesUpload/rootfs.gz; /bin/tar -xvf "
                            + getNeoLocation()
                            + "ImagesUpload/rootfs.gz -C "
                            + getNeoLocation()
                            + "ImageBoot/"
                            + target
                            + " > /dev/null 2>&1"
                        ...
                        rc = os.system(cmd)
                        cmd = (
                            "rm -f " + getNeoLocation() + "ImagesUpload/*.jpg "
                            " > /dev/null 2>&1"
                        )
                        rc = os.system(cmd)
    else:
