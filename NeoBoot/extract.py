...
def NEOBootMainEx(
    ...
    list_one = ['rm -r ' + media_target + dev_null, 'mkdir ' +
                media_target + dev_null, 'chmod -R 0777 ' + media_target]
    ...
    if not os.path.exists(
        ...
        os.system('mkdir -p %s/ImageBoot/%s/usr/lib/enigma2/python' %
                  (media, target))
        os.system(
    ...
    if CopyFiles == 'False':
        ...
        os.system('touch  ' + getNeoLocation() +
    ...
    if not os.path.exists(
        ...
        if LanWlan == 'True':
            ...
            if os.path.exists('/etc/wpa_supplicant.conf'):
                cmd = 'cp -af /etc/wpa_supplicant.conf %s/ImageBoot/%s/etc/wpa_supplicant.conf > /dev/null 2>&1' % (
                    media, target)
                rc = os.system(cmd)
        ...
        if BlackHole == 'True':
            if 'BlackHole' in source or os.path.exists(
                ...
                temp_file2.write(content.replace(
                    '/proc/blackhole/version', '/boot/blackhole/version'))
                temp_file2.close()
...
#    rc = os.system(cmd)
    ...
    os.system(
        ...
        getNeoLocation() +
        'ImageBoot/.data')
    os.system('mv -f ' + getNeoLocation() + 'ImageBoot/.data ' +
              getNeoLocation() + 'ImageBoot/%s/.data' % target)
    cmd = 'touch /tmp/.init_reboot'
    rc = os.system(cmd)
    out = open(mediahome + '.neonextboot', 'w')
    out.write(target)
    out.close()
    os.system('cp ' + getNeoLocation() + 'ImageBoot/.neonextboot ' +
              getNeoLocation() + 'ImageBoot/%s/.multinfo' % target)
    out = open(mediahome + '.neonextboot', 'w')
    out.write('Flash')
    out.close()
...
def RemoveUnpackDirs():
    ...
    if os.path.exists('' + getNeoLocation() + 'ImagesUpload/unpackedzip'):
        rc = os.system('rm -r ' + getNeoLocation() +
    ...
    if os.path.exists('' + getNeoLocation() + 'ImagesUpload/kernel.bin'):
        rc = os.system('rm -rf ' + getNeoLocation() +
    ...
    if getCPUtype() == 'MIPS' and not os.path.exists(
        ...
        if Nandsim == 'True' or os.path.exists('/tmp/.isnandsim') or os.path.exists(
            ...
            if not os.path.exists(
                '/lib/modules/%s/kernel/drivers/mtd/nand/nandsim.ko' %
                    getKernelVersion()):
                rc = os.system('insmod /tmp/nandsim.ko cache_file=' + getNeoLocation() +
                               # % getKernelVersion())
                               'image_cache first_id_byte=0x20 second_id_byte=0xaa third_id_byte=0x00 fourth_id_byte=0x15;sleep 5')
            else:
                rc = os.system('insmod /lib/modules/' + getKernelVersion() + '/kernel/drivers/mtd/nand/nandsim.ko cache_file=' + getNeoLocation(
                    # % getKernelVersion())
                ) + 'image_cache first_id_byte=0x20 second_id_byte=0xaa third_id_byte=0x00 fourth_id_byte=0x15;sleep 5')
        ...
        # UBI_READER
            ...
            cmd = 'python ' + extensions_path + \
                'NeoBoot/ubi_reader/ubi_extract_files.py rootfs.bin -o' + getNeoLocation() + \
                'ubi'
            rc = os.system(cmd)
            os.chdir('/home/root')
            if os.path.exists('' + getNeoLocation() + 'ubi/dreambox-rootfs '):
                os.system('mv ' + getNeoLocation() + 'ubi/dreambox-rootfs/* ' +
                          getNeoLocation() + 'ImageBoot/%s/' % target)
            else:
                os.system('mv ' + getNeoLocation() + 'ubi/rootfs/* ' +
                          getNeoLocation() + 'ImageBoot/%s/' % target)
...
# ARM
        ...
        # vuplus________________________
            ...
            cmd = 'chmod 777 ' + getNeoLocation() + 'ImagesUpload/vuplus/solo4k/rootfs.tar.bz2; tar -jxf ' + getNeoLocation() + \
                'ImagesUpload/vuplus/solo4k/rootfs.tar.bz2 -C ' + \
            ...
            cmd = 'chmod 777 ' + getNeoLocation() + 'ImagesUpload/vuplus/uno4k/rootfs.tar.bz2; tar -jxf ' + getNeoLocation() + \
                'ImagesUpload/vuplus/uno4k/rootfs.tar.bz2 -C ' + \
                getNeoLocation() + 'ImageBoot/' + target + ' > /dev/null 2>&1'
            rc = os.system(cmd)
            ...
            cmd = 'chmod 777 ' + getNeoLocation() + 'ImagesUpload/vuplus/uno4kse/rootfs.tar.bz2; tar -jxf ' + getNeoLocation() + \
                'ImagesUpload/vuplus/uno4kse/rootfs.tar.bz2 -C ' + \
                getNeoLocation() + 'ImageBoot/' + target + ' > /dev/null 2>&1'
            rc = os.system(cmd)
            ...
            cmd = 'chmod 777 ' + getNeoLocation() + 'ImagesUpload/vuplus/zero4k/rootfs.tar.bz2; tar -jxf ' + getNeoLocation() + \
                'ImagesUpload/vuplus/zero4k/rootfs.tar.bz2 -C ' + \
                getNeoLocation() + 'ImageBoot/' + target + ' > /dev/null 2>&1'
            rc = os.system(cmd)
            ...
            cmd = 'chmod 777 ' + getNeoLocation() + 'ImagesUpload/vuplus/ultimo4k/rootfs.tar.bz2; tar -jxf ' + getNeoLocation() + \
                'ImagesUpload/vuplus/ultimo4k/rootfs.tar.bz2 -C ' + \
                getNeoLocation() + 'ImageBoot/' + target + ' > /dev/null 2>&1'
            rc = os.system(cmd)
            ...
            cmd = 'chmod 777 ' + getNeoLocation() + 'ImagesUpload/vuplus/duo4k/rootfs.tar.bz2; tar -jxf ' + getNeoLocation() + \
                'ImagesUpload/vuplus/duo4k/rootfs.tar.bz2 -C ' + \
                getNeoLocation() + 'ImageBoot/' + target + ' > /dev/null 2>&1'
            rc = os.system(cmd)
            ...
            cmd = 'chmod 777 ' + getNeoLocation() + 'ImagesUpload/vuplus/duo4kse/rootfs.tar.bz2; tar -jxf ' + getNeoLocation() + \
                'ImagesUpload/vuplus/duo4kse/rootfs.tar.bz2 -C ' + \
                getNeoLocation() + 'ImageBoot/' + target + ' > /dev/null 2>&1'
            rc = os.system(cmd)
        # ________________________________
            ...
            cmd = 'chmod 777 ' + getNeoLocation() + 'ImagesUpload/sf4008/rootfs.tar.bz2; tar -jxf ' + getNeoLocation() + \
                'ImagesUpload/sf4008/rootfs.tar.bz2 -C ' + getNeoLocation() + 'ImageBoot/' + \
                target + ' > /dev/null 2>&1'
            rc = os.system(cmd)
        elif os.path.exists('' + getNeoLocation() + 'ImagesUpload/octagon/sf8008m'):
            ...
            cmd = 'chmod 777 ' + getNeoLocation() + 'ImagesUpload/octagon/sf8008m/rootfs.tar.bz2; tar -jxf ' + getNeoLocation() + \
                'ImagesUpload/octagon/sf8008m/rootfs.tar.bz2 -C ' + \
                getNeoLocation() + 'ImageBoot/' + target + ' > /dev/null 2>&1'
            rc = os.system(cmd)
        elif os.path.exists('' + getNeoLocation() + 'ImagesUpload/octagon/sf8008'):
            ...
            cmd = 'chmod 777 ' + getNeoLocation() + 'ImagesUpload/octagon/sf8008/rootfs.tar.bz2; tar -jxf ' + getNeoLocation() + \
                'ImagesUpload/octagon/sf8008/rootfs.tar.bz2 -C ' + \
                getNeoLocation() + 'ImageBoot/' + target + ' > /dev/null 2>&1'
            rc = os.system(cmd)
        elif os.path.exists('' + getNeoLocation() + 'ImagesUpload/osmio4k'):
            ...
            cmd = 'chmod 777 ' + getNeoLocation() + 'ImagesUpload/osmio4k/rootfs.tar.bz2; tar -jxf ' + getNeoLocation() + \
                'ImagesUpload/osmio4k/rootfs.tar.bz2 -C ' + getNeoLocation() + 'ImageBoot/' + \
                target + ' > /dev/null 2>&1'
            rc = os.system(cmd)
        elif os.path.exists('' + getNeoLocation() + 'ImagesUpload/osmio4kplus'):
            os.system(
            ...
            cmd = 'chmod 777 ' + getNeoLocation() + 'ImagesUpload/osmio4kplus/rootfs.tar.bz2; tar -jxf ' + getNeoLocation() + \
                'ImagesUpload/osmio4kplus/rootfs.tar.bz2 -C ' + \
                getNeoLocation() + 'ImageBoot/' + target + ' > /dev/null 2>&1'
            rc = os.system(cmd)
        elif os.path.exists('' + getNeoLocation() + 'ImagesUpload/osmini4k'):
            os.system(
            ...
            cmd = 'chmod 777 ' + getNeoLocation() + 'ImagesUpload/osmini4k/rootfs.tar.bz2; tar -jxf ' + getNeoLocation() + \
                'ImagesUpload/osmini4k/rootfs.tar.bz2 -C ' + getNeoLocation() + 'ImageBoot/' + \
                target + ' > /dev/null 2>&1'
            rc = os.system(cmd)
        elif os.path.exists('' + getNeoLocation() + 'ImagesUpload/dm900'):
            ...
            cmd = 'chmod 777 ' + getNeoLocation() + 'ImagesUpload/dm900/rootfs.tar.bz2; tar -jxf ' + getNeoLocation() + \
                'ImagesUpload/dm900/rootfs.tar.bz2 -C ' + getNeoLocation() + 'ImageBoot/' + \
                target + ' > /dev/null 2>&1'
            rc = os.system(cmd)
        elif os.path.exists('' + getNeoLocation() + 'ImagesUpload/dm920'):
            ...
            cmd = 'chmod 777 ' + getNeoLocation() + 'ImagesUpload/dm920; tar -jxf ' + getNeoLocation() + \
                'ImagesUpload/dm920/rootfs.tar.bz2 -C ' + getNeoLocation() + 'ImageBoot/' + \
                target + ' > /dev/null 2>&1'
            rc = os.system(cmd)
        elif os.path.exists('' + getNeoLocation() + 'ImagesUpload/dreamtwo'):
            os.system(
            ...
            cmd = 'chmod 777 ' + getNeoLocation() + 'ImagesUpload/dreamtwo; tar -jxf ' + getNeoLocation() + \
                'ImagesUpload/dreamtwo/rootfs.tar.bz2 -C ' + getNeoLocation() + 'ImageBoot/' + \
                target + ' > /dev/null 2>&1'
            rc = os.system(cmd)
            ...
            cmd = 'chmod 777 ' + getNeoLocation() + 'ImagesUpload/hd51/rootfs.tar.bz2; tar -jxf ' + getNeoLocation() + \
                'ImagesUpload/hd51/rootfs.tar.bz2 -C ' + getNeoLocation() + 'ImageBoot/' + \
                target + ' > /dev/null 2>&1'
            rc = os.system(cmd)
        elif os.path.exists('' + getNeoLocation() + 'ImagesUpload/hd60'):
            ...
            cmd = 'chmod 777 ' + getNeoLocation() + 'ImagesUpload/hd60/rootfs.tar.bz2; tar -jxf ' + getNeoLocation() + \
                'ImagesUpload/hd60/rootfs.tar.bz2 -C ' + getNeoLocation() + 'ImageBoot/' + \
                target + ' > /dev/null 2>&1'
            rc = os.system(cmd)
        elif os.path.exists('' + getNeoLocation() + 'ImagesUpload/hd61'):
            os.system('echo "Please wait. System installation AX HD60 4K"')
            cmd = 'chmod 777 ' + getNeoLocation() + 'ImagesUpload/hd61/rootfs.tar.bz2; tar -jxf ' + getNeoLocation() + \
                'ImagesUpload/hd61/rootfs.tar.bz2 -C ' + getNeoLocation() + 'ImageBoot/' + \
                target + ' > /dev/null 2>&1'
            rc = os.system(cmd)
...
#            rc = os.system(cmd)
            ...
            cmd = 'chmod 777 ' + getNeoLocation() + 'ImagesUpload/multibox/rootfs.tar.bz2; tar -jxf ' + getNeoLocation() + \
                'ImagesUpload/multibox/rootfs.tar.bz2 -C ' + getNeoLocation() + 'ImageBoot/' + \
                target + ' > /dev/null 2>&1'
            rc = os.system(cmd)
        elif os.path.exists('' + getNeoLocation() + 'ImagesUpload/multiboxse'):
            ...
            cmd = 'chmod 777 ' + getNeoLocation() + 'ImagesUpload/multiboxse/rootfs.tar.bz2; tar -jxf ' + getNeoLocation() + \
                'ImagesUpload/multiboxse/rootfs.tar.bz2 -C ' + \
                getNeoLocation() + 'ImageBoot/' + target + ' > /dev/null 2>&1'
            rc = os.system(cmd)
            ...
            cmd = 'chmod 777 ' + getNeoLocation() + 'ImagesUpload/axas/axasc4k/rootfs.tar.bz2; tar -jxf ' + getNeoLocation() + \
                'ImagesUpload/axas/axasc4k/rootfs.tar.bz2 -C ' + \
                getNeoLocation() + 'ImageBoot/' + target + ' > /dev/null 2>&1'
            rc = os.system(cmd)
        elif os.path.exists('' + getNeoLocation() + 'ImagesUpload/e4hd'):
            os.system(
            ...
            cmd = 'chmod 777 ' + getNeoLocation() + 'ImagesUpload/e4hd/rootfs.tar.bz2; tar -jxf ' + getNeoLocation() + \
                'ImagesUpload/e4hd/rootfs.tar.bz2 -C ' + getNeoLocation() + 'ImageBoot/' + \
                target + ' > /dev/null 2>&1'
            rc = os.system(cmd)
            ...
            cmd = 'chmod 777 ' + getNeoLocation() + 'ImagesUpload/gigablue/quad4k/rootfs.tar.bz2; tar -jxf ' + getNeoLocation() + \
                'ImagesUpload/gigablue/quad4k/rootfs.tar.bz2 -C ' + \
                getNeoLocation() + 'ImageBoot/' + target + ' > /dev/null 2>&1'
            rc = os.system(cmd)
            ...
            cmd = 'chmod 777 ' + getNeoLocation() + 'ImagesUpload/gigablue/ue4k/rootfs.tar.bz2; tar -jxf ' + getNeoLocation() + \
                'ImagesUpload/gigablue/ue4k/rootfs.tar.bz2 -C ' + \
                getNeoLocation() + 'ImageBoot/' + target + ' > /dev/null 2>&1'
            rc = os.system(cmd)
            ...
            cmd = 'chmod 777 ' + getNeoLocation() + 'ImagesUpload/update/revo4k/rootfs.tar.bz2; tar -jxf ' + getNeoLocation() + \
                'ImagesUpload/update/revo4k/rootfs.tar.bz2 -C ' + \
                getNeoLocation() + 'ImageBoot/' + target + ' > /dev/null 2>&1'
            rc = os.system(cmd)
            ...
            cmd = 'chmod 777 ' + getNeoLocation() + 'ImagesUpload/update/force3uhd/rootfs.tar.bz2; tar -jxf ' + getNeoLocation() + \
                'ImagesUpload/update/force3uhd/rootfs.tar.bz2 -C ' + \
                getNeoLocation() + 'ImageBoot/' + target + ' > /dev/null 2>&1'
            rc = os.system(cmd)
            ...
            cmd = 'chmod 777 ' + getNeoLocation() + 'ImagesUpload/update/galaxy4k/rootfs.tar.bz2; tar -jxf ' + getNeoLocation() + \
                'ImagesUpload/update/galaxy4k/rootfs.tar.bz2 -C ' + \
                getNeoLocation() + 'ImageBoot/' + target + ' > /dev/null 2>&1'
            rc = os.system(cmd)
            ...
            cmd = 'chmod 777 ' + getNeoLocation() + 'ImagesUpload/zgemma/h7/rootfs.tar.bz2; tar -jxf ' + getNeoLocation() + \
                'ImagesUpload/zgemma/h7/rootfs.tar.bz2 -C ' + getNeoLocation() + 'ImageBoot/' + \
                target + ' > /dev/null 2>&1'
            rc = os.system(cmd)
            ...
            cmd = 'chmod 777 ' + getNeoLocation() + 'ImagesUpload/zgemma/h9/rootfs.tar.bz2; tar -jxf ' + getNeoLocation() + \
                'ImagesUpload/zgemma/h9/rootfs.tar.bz2 -C ' + getNeoLocation() + 'ImageBoot/' + \
                target + ' > /dev/null 2>&1'
            rc = os.system(cmd)
            ...
            cmd = 'chmod 777 ' + getNeoLocation() + 'ImagesUpload/zgemma/h9se/rootfs.tar.bz2; tar -jxf ' + getNeoLocation() + \
                'ImagesUpload/zgemma/h9se/rootfs.tar.bz2 -C ' + \
                getNeoLocation() + 'ImageBoot/' + target + ' > /dev/null 2>&1'
            rc = os.system(cmd)
            ...
            cmd = 'chmod 777 ' + getNeoLocation() + 'ImagesUpload/zgemma/i55plus/rootfs.tar.bz2; tar -jxf ' + getNeoLocation() + \
                'ImagesUpload/zgemma/i55plus/rootfs.tar.bz2 -C ' + \
                getNeoLocation() + 'ImageBoot/' + target + ' > /dev/null 2>&1'
            rc = os.system(cmd)
            ...
            cmd = 'chmod 777 ' + getNeoLocation() + 'ImagesUpload/h9combo/rootfs.tar.bz2; tar -jxf ' + getNeoLocation() + \
                'ImagesUpload/h9combo/rootfs.tar.bz2 -C ' + getNeoLocation() + 'ImageBoot/' + \
                target + ' > /dev/null 2>&1'
            rc = os.system(cmd)
            ...
            cmd = 'chmod 777 ' + getNeoLocation() + 'ImagesUpload/h9combose/rootfs.tar.bz2; tar -jxf ' + getNeoLocation() + \
                'ImagesUpload/h9combose/rootfs.tar.bz2 -C ' + getNeoLocation() + 'ImageBoot/' + \
                target + ' > /dev/null 2>&1'
            rc = os.system(cmd)
            ...
            cmd = 'chmod 777 ' + getNeoLocation() + 'ImagesUpload/h10/rootfs.tar.bz2; tar -jxf ' + getNeoLocation() + \
                'ImagesUpload/h10/rootfs.tar.bz2 -C ' + getNeoLocation() + 'ImageBoot/' + \
                target + ' > /dev/null 2>&1'
            rc = os.system(cmd)
            ...
            cmd = 'chmod 777 ' + getNeoLocation() + 'ImagesUpload/h11/rootfs.tar.bz2; tar -jxf ' + getNeoLocation() + \
                'ImagesUpload/h11/rootfs.tar.bz2 -C ' + getNeoLocation() + 'ImageBoot/' + \
                target + ' > /dev/null 2>&1'
            rc = os.system(cmd)
            ...
            cmd = 'chmod 777 ' + getNeoLocation() + 'ImagesUpload/miraclebox/mini4k/rootfs.tar.bz2; tar -jxf ' + getNeoLocation() + \
                'ImagesUpload/miraclebox/mini4k/rootfs.tar.bz2 -C ' + \
                getNeoLocation() + 'ImageBoot/' + target + ' > /dev/null 2>&1'
            rc = os.system(cmd)
            ...
            cmd = 'chmod 777 ' + getNeoLocation() + 'ImagesUpload/miraclebox/ultra4k/rootfs.tar.bz2; tar -jxf ' + getNeoLocation() + \
                'ImagesUpload/miraclebox/ultra4k/rootfs.tar.bz2 -C ' + \
                getNeoLocation() + 'ImageBoot/' + target + ' > /dev/null 2>&1'
            rc = os.system(cmd)
            ...
            cmd = 'chmod 777 ' + getNeoLocation() + 'ImagesUpload/update/lunix3-4k; tar -jxf ' + getNeoLocation() + \
                'ImagesUpload/update/lunix3-4k/rootfs.tar.bz2 -C ' + \
                getNeoLocation() + 'ImageBoot/' + target + ' > /dev/null 2>&1'
            rc = os.system(cmd)
            ...
            cmd = 'chmod 777 ' + getNeoLocation() + 'ImagesUpload/update/lunix4k; tar -jxf ' + getNeoLocation() + \
                'ImagesUpload/update/lunix4k/rootfs.tar.bz2 -C ' + \
                getNeoLocation() + 'ImageBoot/' + target + ' > /dev/null 2>&1'
            rc = os.system(cmd)
            ...
            cmd = 'chmod 777 ' + getNeoLocation() + 'ImagesUpload/dinobot/u5; tar -jxf ' + getNeoLocation() + \
                'ImagesUpload/dinobot/u5/rootfs.tar.bz2 -C ' + \
                getNeoLocation() + 'ImageBoot/' + target + ' > /dev/null 2>&1'
            rc = os.system(cmd)
            ...
            cmd = 'chmod 777 ' + getNeoLocation() + 'ImagesUpload/dinobot/u51; tar -jxf ' + getNeoLocation() + \
                'ImagesUpload/dinobot/u51/rootfs.tar.bz2 -C ' + \
                getNeoLocation() + 'ImageBoot/' + target + ' > /dev/null 2>&1'
            rc = os.system(cmd)
            ...
            cmd = 'chmod 777 ' + getNeoLocation() + 'ImagesUpload/dinobot/u52; tar -jxf ' + getNeoLocation() + \
                'ImagesUpload/dinobot/u52/rootfs.tar.bz2 -C ' + \
                getNeoLocation() + 'ImageBoot/' + target + ' > /dev/null 2>&1'
            rc = os.system(cmd)
            ...
            cmd = 'chmod 777 ' + getNeoLocation() + 'ImagesUpload/dinobot/u53; tar -jxf ' + getNeoLocation() + \
                'ImagesUpload/dinobot/u53/rootfs.tar.bz2 -C ' + \
                getNeoLocation() + 'ImageBoot/' + target + ' > /dev/null 2>&1'
            rc = os.system(cmd)
            ...
            cmd = 'chmod 777 ' + getNeoLocation() + 'ImagesUpload/dinobot/uu55; tar -jxf ' + getNeoLocation() + \
                'ImagesUpload/dinobot/u55/rootfs.tar.bz2 -C ' + \
                getNeoLocation() + 'ImageBoot/' + target + ' > /dev/null 2>&1'
            rc = os.system(cmd)
            ...
            cmd = 'chmod 777 ' + getNeoLocation() + 'ImagesUpload/dinobot/u5pvr; tar -jxf ' + getNeoLocation() + \
                'ImagesUpload/dinobot/u5pvr/rootfs.tar.bz2 -C ' + \
                getNeoLocation() + 'ImageBoot/' + target + ' > /dev/null 2>&1'
            rc = os.system(cmd)
            ...
            cmd = 'chmod 777 ' + getNeoLocation() + 'ImagesUpload/dinobot/u57; tar -jxf ' + getNeoLocation() + \
                'ImagesUpload/dinobot/u57/rootfs.tar.bz2 -C ' + \
                getNeoLocation() + 'ImageBoot/' + target + ' > /dev/null 2>&1'
            rc = os.system(cmd)
            ...
            cmd = 'chmod 777 ' + getNeoLocation() + 'ImagesUpload/uclan/ustym4kpro; tar -jxf ' + getNeoLocation() + \
                'ImagesUpload/uclan/ustym4kpro/rootfs.tar.bz2 -C ' + \
                getNeoLocation() + 'ImageBoot/' + target + ' > /dev/null 2>&1'
            rc = os.system(cmd)
        elif os.path.exists('' + getNeoLocation() + 'ImagesUpload/ustym4kpro'):
            os.system(
            ...
            cmd = 'chmod 777 ' + getNeoLocation() + 'ImagesUpload/ustym4kpro; tar -jxf ' + getNeoLocation() + \
                'ImagesUpload/ustym4kpro/rootfs.tar.bz2 -C ' + \
                getNeoLocation() + 'ImageBoot/' + target + ' > /dev/null 2>&1'
            rc = os.system(cmd)
        elif os.path.exists('' + getNeoLocation() + 'ImagesUpload/et1x000'):
            os.system(
            ...
            cmd = 'chmod 777 ' + getNeoLocation() + 'ImagesUpload/et1x000; tar -jxf ' + getNeoLocation() + \
                'ImagesUpload/et1x000/rootfs.tar.bz2 -C ' + getNeoLocation() + 'ImageBoot/' + \
                target + ' > /dev/null 2>&1'
            rc = os.system(cmd)
            ...
            cmd = 'chmod 777 ' + getNeoLocation() + 'ImagesUpload/e2/update; tar -jxf ' + getNeoLocation() + \
                'ImagesUpload/e2/update/rootfs.tar.bz2 -C ' + getNeoLocation() + 'ImageBoot/' + \
                target + ' > /dev/null 2>&1'
            rc = os.system(cmd)
            ...
            cmd = 'chmod 777 ' + getNeoLocation() + 'ImagesUpload/beyonwiz/v2; tar -jxf ' + getNeoLocation() + \
                'ImagesUpload/beyonwiz/v2/rootfs.tar.bz2 -C ' + \
                getNeoLocation() + 'ImageBoot/' + target + ' > /dev/null 2>&1'
            rc = os.system(cmd)
            ...
            cmd = 'chmod 777 ' + getNeoLocation() + 'ImagesUpload/amiko/viper4k; tar -jxf ' + getNeoLocation() + \
                'ImagesUpload/amiko/viper4k/rootfs.tar.bz2 -C ' + \
                getNeoLocation() + 'ImageBoot/' + target + ' > /dev/null 2>&1'
            rc = os.system(cmd)
            ...
            cmd = 'chmod 777 ' + getNeoLocation() + 'ImagesUpload/update/tmtwin4k/rootfs.tar.bz2; tar -jxf ' + getNeoLocation() + \
                'ImagesUpload/update/tmtwin4k/rootfs.tar.bz2 -C ' + \
                getNeoLocation() + 'ImageBoot/' + target + ' > /dev/null 2>&1'
            rc = os.system(cmd)
            ...
            cmd = 'chmod 777 ' + getNeoLocation() + 'ImagesUpload/gigablue/trio4k; tar -jxf ' + getNeoLocation() + \
                'ImagesUpload/gigablue/trio4k/rootfs.tar.bz2 -C ' + \
                getNeoLocation() + 'ImageBoot/' + target + ' > /dev/null 2>&1'
            rc = os.system(cmd)
            ...
            cmd = 'chmod 777 ' + getNeoLocation() + 'ImagesUpload/gigablue/ip4k; tar -jxf ' + getNeoLocation() + \
                'ImagesUpload/gigablue/ip4k/rootfs.tar.bz2 -C ' + \
                getNeoLocation() + 'ImageBoot/' + target + ' > /dev/null 2>&1'
            rc = os.system(cmd)
            ...
            cmd = 'chmod 777 ' + getNeoLocation() + 'ImagesUpload/gigablue/x34k; tar -jxf ' + getNeoLocation() + \
                'ImagesUpload/gigablue/x34k/rootfs.tar.bz2 -C ' + \
                getNeoLocation() + 'ImageBoot/' + target + ' > /dev/null 2>&1'
            rc = os.system(cmd)
        elif os.path.exists('' + getNeoLocation() + 'ImagesUpload/protek4k'):
            ...
            cmd = 'chmod 777 ' + getNeoLocation() + 'ImagesUpload/protek4k; tar -jxf ' + getNeoLocation() + \
                'ImagesUpload/protek4k/rootfs.tar.bz2 -C ' + getNeoLocation() + 'ImageBoot/' + \
                target + ' > /dev/null 2>&1'
            rc = os.system(cmd)
        elif os.path.exists('' + getNeoLocation() + 'ImagesUpload/pulse4k'):
            os.system(
            ...
            cmd = 'chmod 777 ' + getNeoLocation() + 'ImagesUpload/pulse4k; tar -jxf ' + getNeoLocation() + \
                'ImagesUpload/pulse4k/rootfs.tar.bz2 -C ' + getNeoLocation() + 'ImageBoot/' + \
                target + ' > /dev/null 2>&1'
            rc = os.system(cmd)
            ...
            cmd = 'chmod 777 ' + getNeoLocation() + 'ImagesUpload/pulse4kmini; tar -jxf ' + getNeoLocation() + \
                'ImagesUpload/pulse4kmini/rootfs.tar.bz2 -C ' + \
                getNeoLocation() + 'ImageBoot/' + target + ' > /dev/null 2>&1'
            rc = os.system(cmd)
        elif os.path.exists('' + getNeoLocation() + 'ImagesUpload/bre2ze4k'):
            ...
            cmd = 'chmod 777 ' + getNeoLocation() + 'ImagesUpload/bre2ze4k; tar -jxf ' + getNeoLocation() + \
                'ImagesUpload/bre2ze4k/rootfs.tar.bz2 -C ' + getNeoLocation() + 'ImageBoot/' + \
                target + ' > /dev/null 2>&1'
            rc = os.system(cmd)
        # Vimastec
        elif os.path.exists('' + getNeoLocation() + 'ImagesUpload/vs1500'):
            ...
            cmd = 'chmod 777 ' + getNeoLocation() + 'ImagesUpload/vs1500; tar -jxf ' + getNeoLocation() + \
                'ImagesUpload/vs1500/rootfs.tar.bz2 -C ' + getNeoLocation() + 'ImageBoot/' + \
                target + ' > /dev/null 2>&1'
            rc = os.system(cmd)
            ...
            if fn.find('.rootfs.tar.xz') != -1:
                if not os.path.exists('/tmp/xz-gz-tar'):
                    ...
                    cmd = 'chmod 777 ' + getNeoLocation() + 'ImagesUpload/rootfs.tar.xz; tar -xf ' + getNeoLocation() + \
                        'ImagesUpload/rootfs.tar.xz -C ' + getNeoLocation() + 'ImageBoot/' + \
                        target + ' > /dev/null 2>&1'
                    rc = os.system(cmd)
                    rc = os.system('rm -r ' + getNeoLocation() +
                                   '/ImagesUpload/rootfs.tar.xz')
                ...
                if not os.path.exists('/tmp/xz-gz-tar'):
                    ...
                    cmd = 'chmod 777 ' + getNeoLocation() + 'ImagesUpload/rootfs.tar.gz; /bin/tar -xzvf ' + getNeoLocation() + \
                        'ImagesUpload/rootfs.tar.gz -C ' + getNeoLocation() + 'ImageBoot/' + \
                        target + ' > /dev/null 2>&1'
                    rc = os.system(cmd)
                    rc = os.system('rm -r ' + getNeoLocation() +
                                   '/ImagesUpload/rootfs.tar.gz')
                ...
                if not os.path.exists('/tmp/xz-gz-tar'):
                    ...
                    cmd = 'chmod 777 ' + getNeoLocation() + 'ImagesUpload/rootfs.tar.bz2; tar -jxf ' + getNeoLocation() + \
                        'ImagesUpload/rootfs.tar.bz2 -C ' + getNeoLocation() + 'ImageBoot/' + \
                        target + ' > /dev/null 2>&1'
                    rc = os.system(cmd)
                    rc = os.system('rm -r ' + getNeoLocation() +
                                   '/ImagesUpload/rootfs.tar.bz2')
                ...
                cmd = 'chmod 777 ' + getNeoLocation() + 'ImagesUpload/*.tar.gz; tar -xzvf ' + getNeoLocation() + \
                    'ImagesUpload/*.tar.gz -C ' + getNeoLocation() + 'ImageBoot/' + \
                    target + ' > /dev/null 2>&1'
                rc = os.system(cmd)
                ...
                if not os.path.exists('/tmp/xz-gz-tar'):
                    os.system('touch /tmp/xz-gz-tar')
                    os.system('echo "Installing the file .gz in progress..."')
                    os.system(
                        'mv ' +
                        getNeoLocation() +
                        'ImagesUpload/' +
                    ...
                    cmd = 'chmod 777 ' + getNeoLocation() + 'ImagesUpload/rootfs.gz; /bin/tar -xvf ' + getNeoLocation() + \
                        'ImagesUpload/rootfs.gz -C ' + getNeoLocation() + 'ImageBoot/' + \
                        target + ' > /dev/null 2>&1'
                    rc = os.system(cmd)
                    rc = os.system('rm -r ' + getNeoLocation() +
                                   '/ImagesUpload/rootfs.gz')
